...
export default function Teste(props: VideoProps) {
  ...
  return (
    <div className="flex-1">
      ...
      <div className=" flex align-middle justify-center h-full aspect-video"></div>
      
      {/* <ReactPlayer url={`https://www.youtube.com/watch?v=${data?.lesson.videoId}`} /> */}
            ...
            <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
              ...
              <div className="py-6 leading-relaxed">
                ...
                <p className="text-sm text-gray-200 mt-2">
                  Acess the material and boost your development
                </p>
              </div>
